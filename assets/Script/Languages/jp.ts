export const JP = {
    ...
    Reindeer: "トナカイ",
    ReindeerSilicon: "トナカイのシリコン",
    ReindeerSiliconDesc: "シリコンを消費するすべての建物に、代わりにトナカイを使用します(無料)",
    ReindeerAluminum: "トナカイのアルミニウム",
    ReindeerAluminumDesc: "アルミニウムを消費するすべての建物に、代わりにトナカイを使用します(無料)",
    SantaClauseIsComing: "サンタクロースがやってくる",
    SantaClauseIsComingDesc:
        "サンタ工場はトナカイとおもちゃを消費し、サンタ、科学、文化を生産します。 サンタ工場は最大タイル修正を持ちます。 おもちゃ工場はおもちゃに加えてトナカイを生産します(無料)",
    MetaRebranding: "メタ リブランディング",
    MetaRebrandingDesc:
        "Social・Network社はMeta社に社名変更し、代わりにインターネット、ゲーム、スーパーコンピューター、ビットコイン、ドージコインを消費します。",
    MetaInc: "株式会社Meta",
    ImportSave: "セーブをインポート",
    SaveVersionTooNew:
        "あなたのセーブは %{saveVersion} ですが、あなたのゲームバージョンは %{gameVersion} です。ゲームをアップデートしてください。",
    LeaderboardByFlag: "Flagのリーダーボード",
    LeaderboardByMap: "マップのリーダーボード",
    LeaderboardByFlagPlayerFlag: "Flag",
    LeaderboardByFlagPayerCount: "#",
    LeaderboardByFlagPayerValuationPerHour: "V/H",
    LeaderboardByFlagPayerSwissMoney: "スイスマネー",
    PlayerTradePriceFilter: "価格フィルター",
    PlayerTradeFilterBetterThanMarket: "市場より良い",
    PlayerTradeFilterAll: "全て",
    PlayerTradeFilterBestPrice: "最も安い単価",
    CrowdfundingTotalPledgdeValueTooLarge:
        "クラウドファンディングの誓約総額は、あなたの現在の市場価格を超えることはできません。",
    BuildingSourceAuto: "自動",
    BuildingSourceManual: "🔍 手動",
    BuildingSourceReset: "リセット",
    BuildingSourceSelecting: "マップをタップしてください...",
    BuildingSourceSetOverride: "オーバーライド",
